...
# 禁用 Next.js 遥测，避免构建阶段网络超时
ENV NEXT_TELEMETRY_DISABLED=1
# 显式指定 Prisma Client 生成位置，防止某些环境下的路径问题
...
RUN IS_BUILDING=true NEXT_PHASE=phase-production-build DATABASE_URL="mysql://dummy:dummy@localhost:3306/dummy" REDIS_HOST="127.0.0.1" npm run build
